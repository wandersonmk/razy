...
<template>
  <div>
    ...
    <ConfirmModal
      ...
      :message="`Remover '${confirmExcluir.profissional?.nome}'? O canal dele fica sem dono (não é apagado). Se já tiver conversas registradas, a exclusão é bloqueada — desative-o em vez de excluir.`"
